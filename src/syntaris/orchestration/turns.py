...
def execute_turn(context: RuntimeContext, request: TalkRequest, source: str = "talk_once") -> TalkRunResult:
    ...
    plan_trace = ResponsePlanTrace(
        ...
        style_constraints=response_plan.style_constraints,
        chat_lock_active=response_plan.chat_lock_active,
        chat_lock_strength=response_plan.chat_lock_strength,
        direct_answer_required=response_plan.direct_answer_required,
        direct_answer_present=response_plan.direct_answer_present,
        clarification_needed=response_plan.clarification_needed,
        clarification_reason=response_plan.clarification_reason,
        anti_hijack_guarded=response_plan.anti_hijack_guarded,
        ack_collapse_risk=response_plan.ack_collapse_risk,
        ...
        composition_recap_used=response_plan.composition_recap_used,
        composition_next_step_used=response_plan.composition_next_step_used,
        composition_reflective_lead_used=response_plan.composition_reflective_lead_used,
        surface_hijack_guarded=response_plan.surface_hijack_guarded,
    )
